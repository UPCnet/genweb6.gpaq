...
#
#  $ bin/test -s genweb6.gpaq -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src genweb6.gpaq.testing.GENWEB6_GPAQ_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/genweb6/gpaq/tests/robot/test_example.robot
#
